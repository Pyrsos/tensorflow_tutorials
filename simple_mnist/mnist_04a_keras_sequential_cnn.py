'''
Example script for constructing CNN using Keras for classifying the MNIST dataset using keras.
'''
from absl import flags
import numpy as np
import tensorflow as tf
from pyrsostf.data import MNIST
from pyrsostf.plots import print_confusion_matrix, find_wrong_predictions, plot_images
